...
public class GLProgram420SP {
    ...
    private static final String FRAGMENT_SHADER_420SP = 
    		...
    		"}\n" + 
    		"void main() {\n" + 
    		"vec4 yuv = semiplanarYUV(tex_y, tex_uv, tc);\n" + 
     ...
     * right-bottom => 4
     */
    public GLProgram420SP(int position) {
    ...
    public void buildProgram() {
        ...
        _program = createProgram(VERTEX_SHADER, FRAGMENT_SHADER_420SP);
